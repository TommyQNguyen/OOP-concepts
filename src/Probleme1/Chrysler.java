...
public class Chrysler extends Auto
{
...
public Chrysler (String couleur, int prix, boolean enStock, boolean preparee, int anFabrication, String marque, String modele)
{
